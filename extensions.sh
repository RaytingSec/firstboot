...
echo "Installing Impatience..."
git clone --depth=1 https://github.com/timbertson/gnome-shell-impatience.git
cp -r ./gnome-shell-impatience/impatience $EXT_PATH/impatience@gfxmonk.net

echo "Installing DashToDock..."
...
echo "Installing MiddleClickClose..."
git clone --depth=1 https://github.com/p91paul/middleclickclose.git
cp -r middleclickclose/middleclickclose@paolo.tranquilli.gmail.com/ $EXT_PATH

echo "Installing TopIcons Plus"
git clone --depth=1 https://github.com/phocean/TopIcons-plus.git
cd TopIcons-plus
make install
cd ..

echo "Installing WindowOverlay Icons..."
git clone --depth=1 https://github.com/sustmi/gnome-shell-extension-windowoverlay-icons.git
cd gnome-shell-extension-windowoverlay-icons/
make zip
mkdir -p $EXT_PATH/windowoverlay-icons@sustmidown.centrum.cz/
unzip windowoverlay-icons.zip -d $EXT_PATH/windowoverlay-icons@sustmidown.centrum.cz/

echo "Configuring extensions through dconf..."
