...
function dynamic-panel-transparency () {
...
function net-gfxmonk-impatience () {
...
clipboard-indicator
windowoverlay-icons
net-gfxmonk-impatience
dash-to-dock

# For Host Machines
# dynamic-panel-transparency  # Deprecated
user-theme
mediaplayer
freon
